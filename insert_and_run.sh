...
while [ $# > 0 ]; do
  ...
  pypy sim.py --verbose 1 --ff -b --ckt ${1}_${2}/bench/pyTrojan_${1}.bench-ckt.bench --bist ${1}_${2}/input/pyTrojan_${1}.bench_inputs.pickle ${1}_${2}/bench/pyTrojan_${1}.bench_001-badckt.bench | tee ${1}_${2}.`hostname`.sim.log
  
  pypy sim.py --verbose 1 -b --ckt ${1}_${2}/bench/pyTrojan_${1}.bench-ckt.bench --bist ${1}_${2}/input/pyTrojan_${1}.bench_inputs.pickle ${1}_${2}/bench/pyTrojan_${1}.bench_*-badckt.bench | tee ${1}_${2}.`hostname`.sim.log
