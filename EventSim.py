...
_EventSim.gate_t_DFF_O_swigconstant(_EventSim)
gate_t_DFF_O = _EventSim.gate_t_DFF_O

_EventSim.gate_t_DFF_swigconstant(_EventSim)
gate_t_DFF = _EventSim.gate_t_DFF
...
class Gate(_object):
    ...
    if _newclass:
        dff_link = _swig_property(_EventSim.Gate_dff_link_get, _EventSim.Gate_dff_link_set)
...
class EventSim(_object):
    ...
    if _newclass:
        dffs = _swig_property(_EventSim.EventSim_dffs_get, _EventSim.EventSim_dffs_set)
